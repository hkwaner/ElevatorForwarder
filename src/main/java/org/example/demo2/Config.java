...
public class Config {
    ...
    //==========================================================================
    public static final Site ACTIVE_SITE = Site.LIMING_HG;
    ...
    public static final int ELEVATOR_PORT = 20108;//电梯监听端口(DTU/5G CPE连接到此端口)
    public static final String ELEVATOR_HOST = ACTIVE_SITE.getElevatorHost();//当前现场电梯IP(服务端模式实际未用)
     ...
     * 通过本类 CodeSource 定位 jar(或classes)真实位置,取其父目录;不依赖当前工作目录。
     */
